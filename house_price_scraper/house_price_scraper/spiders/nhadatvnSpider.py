...
class nhadatvnSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        # with tqdm(total=len(bds_links), desc=f"Processing and saving page: {self.num_page}") as pbar:
        self.progress_bar.append(tqdm(total=len(bds_links), desc=f"Processing page: {self.num_page}"))
